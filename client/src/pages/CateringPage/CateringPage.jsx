        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-lg max-w-2xl mx-auto mb-12">
              From intimate gatherings to large corporate events, All Da Smoke delivers 
              exceptional BBQ catering that will make your event unforgettable.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                <p>Perfect for office parties, meetings, and company celebrations.</p>
              </div>
            </div>
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                <h3 className="card-title">Private Parties</h3>
                <p>Make your birthday, anniversary, or family gathering special.</p>
              </div>
            </div>
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                <h3 className="card-title">Weddings</h3>
                <p>Authentic BBQ for your special day with full-service options.</p>
              </div>
            </div>
          </div>
        </div>
